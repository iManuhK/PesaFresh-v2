...
Revision ID: ace65e0fab12
Revises: 
Create Date: 2024-08-18 04:11:23.011062
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_industries_user_id_users')),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['industry_id'], ['industries.id'], name=op.f('fk_pricing_industry_id_industries')),
    sa.ForeignKeyConstraint(['product_id'], ['products.id'], name=op.f('fk_pricing_product_id_products')),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['pricing_id'], ['pricing.id'], name=op.f('fk_production_pricing_id_pricing')),
    ...
    sa.ForeignKeyConstraint(['production_id'], ['production.id'], name=op.f('fk_credits_production_id_production')),
