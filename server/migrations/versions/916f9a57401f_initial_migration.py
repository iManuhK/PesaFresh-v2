...
Revision ID: 916f9a57401f
Revises: 
Create Date: 2024-08-23 01:00:41.586391
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['payment_id'], ['payments.id'], name=op.f('fk_credits_payment_id_payments')),
